...
class App extends Component {
  ...
  toggleIsFaviroate = (id) => {
      this.setState(prevState => {
contactsList: prevState.contactsList.map(eachItem => {
    if (id === eachItem.id) {
        return {...eachItem, isFaviroate: !eachItem.isFaviroate}
    }
    return eachItem
})
      })
  ...
  onAddContact = event => {
    ...
    this.setState(prevState => ({
        contactList: [...prevState.contactsList, newContact],
        name: "",
        mobileNo: "",
    }))
  }
        ...
        <div className="responsive-container">
          ...
          <ul className="contacts-table">
            ...
            {contactsList.map(eachContact => (
              ...
              toggleIsFaviroate={this.toggleIsFaviroate} />
            ))}
          </ul>
        </div>
      </div>
